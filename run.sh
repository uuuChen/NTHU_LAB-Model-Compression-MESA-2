...
# ----------- VggNet ---------------
# norm-base
python main.py -mm c -prunep -quanp -um vgg16 -pm filter-norm -be 0.1 -b conv=8,fc=5 -sd model_mesa_0.0_vgg_filter_norm -lm model_mesa_VggNet_0.1/checkpoint_initial_beta_0.1_0.tar
