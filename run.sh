...
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 0.0 -clf filter3d-delta -sd model_mesa_0.0_filter_norm_conv -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 0.1 -clf filter3d-delta -sd model_mesa_0.1_filter_norm_conv -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 1.0 -clf filter3d-delta -sd model_mesa_1.0_filter_norm_conv -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 2.0 -clf filter3d-delta -sd model_mesa_2.0_filter_norm_conv -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
# norm-base, part-filter3d-delta loss
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 0.1 -clf part-filter3d-delta -sd model_mesa_0.1_part_filter_norm_conv -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
# norm-base, group-filter3d-delta loss
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 0.1 -clf group-filter3d-delta -sd model_mesa_0.1_group_filter_norm_conv -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 1.0 -clf group-filter3d-delta -sd model_mesa_1.0_group_filter_norm_conv -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
python main.py -mm c -prunep -quanp -encp -b conv=5,fc=5 -pm filter-norm -be 1.0 -clf group-filter3d-delta -sd model_mesa_1.0_group_filter_norm_conv_short_path -lm model_mesa_AlexNet/checkpoint_initial_alpha_0.1_149.tar -prlr 0.001 -prep 200
